...
/* Optional UI-thread observer; must not mutate the object during draw. */
typedef void (*lv_img_draw_status_cb_t)(lv_obj_t *obj, bool success);
void lv_img_set_draw_status_cb(lv_img_draw_status_cb_t cb);
void lv_img_set_draw_retry_cb(bool (*cb)(lv_obj_t *obj));
