...
const char*standby_photo_path(unsigned n){const char*paths[]={"L:/usr/local/share/lvgl_data/standby/silver.png","L:/usr/local/share/lvgl_data/standby/celadon.png","L:/usr/local/share/lvgl_data/standby/champagne.png"};return paths[n<3?n:1];}
