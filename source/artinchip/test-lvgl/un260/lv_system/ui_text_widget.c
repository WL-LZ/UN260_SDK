...
static const ui_text_item_t g_ui_text_widget_group[UI_TEXT_MAX - UI_TEXT_WIDGET_BASE] = {
    ...
    [UI_TEXT_WIDGET_UPGRADE_POPUP_PROGRESS_STEP_PREPARE - UI_TEXT_WIDGET_BASE] = {"Preparing secure upgrade", "正在准备安全升级", "안전한 업그레이드 준비 중"},
    [UI_TEXT_WIDGET_UPGRADE_POPUP_PROGRESS_STEP_EXTRACT - UI_TEXT_WIDGET_BASE] = {"Extracting verified package", "正在解包升级文件", "확인된 패키지 압축 해제 중"},
    [UI_TEXT_WIDGET_UPGRADE_POPUP_PROGRESS_STEP_PREFLIGHT - UI_TEXT_WIDGET_BASE] = {"Checking device and storage", "正在检查设备与存储空间", "장치 및 저장 공간 확인 중"},
    [UI_TEXT_WIDGET_UPGRADE_POPUP_PROGRESS_STEP_INSTALL - UI_TEXT_WIDGET_BASE] = {"Installing system components", "正在安装系统组件", "시스템 구성 요소 설치 중"},
    [UI_TEXT_WIDGET_UPGRADE_POPUP_PROGRESS_STEP_SYNC - UI_TEXT_WIDGET_BASE] = {"Securing data on storage", "正在安全写入存储", "저장소에 데이터 기록 중"},
    [UI_TEXT_WIDGET_UPGRADE_POPUP_PROGRESS_STEP_FINISH - UI_TEXT_WIDGET_BASE] = {"Final integrity check", "正在完成最终检查", "최종 무결성 검사 중"},
